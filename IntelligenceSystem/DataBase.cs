...
namespace IntelligenceSystem
{
    public class DataBase
    {
        ...
        public DataBase()
        {
            ...
            m_variantList.Add(new Variant(45, 8,   3.6, 0.52, 12.5, 15, 3, 0.7,  0.75, 0.02, 0.84, 0.86));
            m_variantList.Add(new Variant(50, 8.5, 3.7, 0.55, 13,   15, 3, 0.69, 0.74, 0.03, 0.83, 0.86));
        }
